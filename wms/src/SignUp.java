...
public class SignUp implements MouseListener {
    ...
    protected JLabel jlabel, jlabel1, jlabel2, jlabel3, jlabel4, jlabel5, jlabel6, jlabel7, jlabel8, jlabel9, jlabel10,
            jlabel11, jlabel12, nextButton, jlabelback, jlabelback1, jlabelback2, jlabwlback3;
    private JTextField jtextfield, jtextfield1, jtextfield2, jtextfield3, jtextfield4, jtextfield5, jtextfield6,
            jtextfield7, jtextfield8, jtextfield9;
    private JPanel jpanel1, jpanel2, jpanel3, jpanel4, jpanel5;
    private String username, password, confirmpassword, fullName, ownerAddress, ownerPhone, ownerEmail, accountType,
            entityName,
    ...
    private void showStep2() {// signup1
        ...
        jlabel4.setBounds(401, 247, 194, 20);
        jpanel2.add(jlabel4);
        jlabel5 = new JLabel();
        jlabel5.setText("Your Address");
        jlabel5.setBounds(401, 304, 194, 20);
        jpanel2.add(jlabel5);
        jlabel6 = new JLabel();
        jlabel6.setText("Enter Phone no.");
        jlabel6.setBounds(401, 361, 194, 20);
        jpanel2.add(jlabel6);
    ...
    private void showStep3() {
        ...
        jlabel7.setBounds(401, 247, 194, 20);
        jpanel3.add(jlabel7);
        jlabel8 = new JLabel();
        jlabel8.setText("Shop Address");
        jlabel8.setBounds(401, 304, 194, 20);
        jpanel3.add(jlabel8);
        jlabel9 = new JLabel();
        jlabel9.setText("Shop Phone no.");
        jlabel9.setBounds(401, 361, 194, 20);
        jpanel3.add(jlabel9);
    ...
    private void showStep4() {
        ...
        jlabel10.setBounds(401, 247, 194, 20);
        jpanel4.add(jlabel10);
        jlabel11 = new JLabel();
        jlabel11.setText("Create Password");
        jlabel11.setBounds(401, 304, 194, 20);
        jpanel4.add(jlabel11);
        jlabel12 = new JLabel();
        jlabel12.setText("Confirm Password");
        jlabel12.setBounds(401, 361, 194, 20);
